...
from Polynym2 import DicomSeries, DicomStudy, DicomSubject


class OrthancInterface2(Interface):

    def __init__(self, **kwargs):
        super(OrthancInterface2, self).__init__(**kwargs)
    ...
    def series_from_id(self, series_id):
        ...
        series_tags = self.do_get('series', series_id, 'tags')
        ...
        if source:
            ...
            for a in answers:
                ...
                if level == 'study':
                    ...
                    item = DicomSeries(item_data['SeriesInstanceUID'])
...
def orthanc_tests2():
    ...
    source = OrthancInterface2(address="http://localhost:8043", aetitle='3DLAB-DEV1')
