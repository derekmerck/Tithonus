...
class HierarchicalPolynym(Polynym2):
...
def test_polynym2():
    ...
    p = Polynym2()
    p.add_map(('test', 0),    ('test1', 1), Polynym2.md5_rule)
    p.add_map(('test', 0),    ('test2', 2), Polynym2.md5_rule)
    p.add_map( 'test_single',  'test_copy', Polynym2.identity_rule)
